/*
Ethan Nguyen, Sandra Cabezas, Sebastian Gomez
 CMPR 121 - Spring 2023
 31 May 2023
 Final Project Part B
 Collaboration: Ethan Nguyen, Sandra Cabezas, Sebastian Gomez
*/
	...
	while (choice != 6)
	{
		...
		case 2:
			...
			if (candidateList.searchCandidate(ssn))
			{
				...
				//cout << endl;
				for (int i = 1; i <= no_of_campuses; ++i)
					candidateList.printCampusVotes(ssn, i);
			}
			cout << endl;
			break;
